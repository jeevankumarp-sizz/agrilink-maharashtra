...
const MAHARASHTRA_DISTRICTS: DistrictInfo[] = [
  {
    ...
    arrivalVolume: 12500,
    demandLevel: "HIGH",
    storageAvailableDays: 60,
    topBuyer: "Sahyadri Farmers Producer Co",
    suggestedAction: "Direct farm-gate procurement active in Lasalgaon hub. High buyer demand.",
  },
  {
    id: "pune",
    name: "Pune",
    ...
    suggestedAction: "Manchar potato hub active. Wholesale buyers offering steady contracts for Jyoti variety.",
  },
  {
    id: "latur",
    name: "Latur",
    ...
    topBuyer: "Nagpur Agro Hub",
    suggestedAction: "Strong institutional oil processor demand. Premium prices for Grade A yellow soybean.",
  },
  {
    id: "akola",
    name: "Akola",
    ...
    topBuyer: "Vidarbha Farmers Syndicate",
    suggestedAction: "Long staple cotton procurement active across Akola APMC yards.",
  },
  {
    id: "nagpur",
    name: "Nagpur",
