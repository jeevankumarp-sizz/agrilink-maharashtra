...
export const DEMO_BUYERS: Buyer[] = [
  buyer("b1", "Sahyadri Farmers Producer Co", "FPO", "Nashik", 19.9975, 73.7898, ["Onion", "Soybean", "Tur (Pigeon Pea)"], 5000, 24, 28, ["Grade A", "Grade B"], 15, 96, 98, "Within 2 days", "HIGH"),
  buyer("b2", "Mahafresh Logistics Pvt Ltd", "Wholesaler", "Pune", 18.5204, 73.8567, ["Potato", "Onion", "Cabbage"], 8000, 20, 26, ["Grade A", "Grade B"], 210, 91, 94, "Within 3 days", "HIGH"),
  buyer("b3", "Maharashtra State Food Corp", "Institutional buyer", "Mumbai", 18.9388, 72.8353, ["Wheat", "Chana (Chickpea)", "Tur (Pigeon Pea)"], 12000, 26, 72, ["Grade A", "Grade B", "Grade C"], 160, 94, 97, "Within 5 days", "MEDIUM"),
  buyer("b4", "WestIndia Agro Exports", "Exporter", "Navi Mumbai", 19.0330, 73.0297, ["Onion", "Green Chilli", "Cauliflower"], 4000, 26, 42, ["Grade A"], 175, 90, 92, "Within 2 days", "HIGH"),
  buyer("b5", "Sangli Agro Processors", "Processor", "Sangli", 16.8524, 74.5815, ["Tur (Pigeon Pea)", "Chana (Chickpea)", "Sugarcane"], 3000, 52, 74, ["Grade A", "Grade B"], 280, 87, 90, "Within 4 days", "MEDIUM"),
  buyer("b6", "Solapur Kisan FPO", "FPO", "Solapur", 17.6599, 75.9064, ["Jowar (Sorghum)", "Tur (Pigeon Pea)", "Chana (Chickpea)"], 6000, 30, 56, ["Grade A", "Grade B"], 320, 92, 95, "Within 4 days", "HIGH"),
  buyer("b7", "MahaAgro Processors", "Processor", "Chhatrapati Sambhajinagar", 19.8762, 75.3433, ["Soybean", "Groundnut", "Maize"], 4500, 22, 58, ["Grade A", "Grade B"], 175, 89, 91, "Within 5 days", "MEDIUM"),
  buyer("b8", "Reliance Retail Bhiwandi Hub", "Retailer", "Bhiwandi", 19.2812, 73.0483, ["Potato", "Onion", "Tomato", "Green Chilli"], 8000, 22, 38, ["Grade A"], 150, 95, 96, "Within 3 days", "HIGH"),
  buyer("b9", "Nagpur Agro Hub", "Wholesaler", "Nagpur", 21.1458, 79.0882, ["Cotton", "Soybean", "Maize"], 5000, 22, 64, ["Grade A", "Grade B", "Grade C"], 680, 84, 87, "Within 6 days", "LOW"),
  buyer("b10", "Vidarbha Farmers Syndicate", "FPO", "Akola", 20.7002, 77.0082, ["Cotton", "Soybean"], 4000, 48, 65, ["Grade A"], 420, 93, 94, "Within 3 days", "HIGH"),
  buyer("b11", "Star Bazaar Procurement", "Retailer", "Pune", 18.5204, 73.8567, ["Onion", "Potato", "Brinjal"], 6500, 20, 27, ["Grade A", "Grade B"], 210, 92, 94, "Within 4 days", "MEDIUM"),
  buyer("b12", "Western Agro Exports", "Exporter", "JNPT Navi Mumbai", 18.9500, 72.9500, ["Onion", "Soybean"], 4500, 25, 52, ["Grade A"], 180, 88, 90, "Within 3 days", "MEDIUM"),
  buyer("b13", "Nashik Mandi Traders", "Wholesaler", "Nashik", 19.9975, 73.7898, ["Onion", "Tomato", "Green Chilli"], 3500, 24, 38, ["Grade A", "Grade B", "Grade C"], 8, 86, 88, "Same day", "HIGH"),
  buyer("b14", "Manchar Potato Processors", "Processor", "Manchar Pune", 19.0000, 73.9400, ["Potato"], 5500, 19, 23, ["Grade A", "Grade B"], 22, 90, 92, "Within 4 days", "HIGH"),
  buyer("b15", "Kolhapur Agro Retail Chain", "Retailer", "Kolhapur", 16.7050, 74.2433, ["Green Chilli", "Brinjal", "Sugarcane"], 3500, 22, 42, ["Grade A", "Grade B"], 340, 88, 90, "Within 3 days", "HIGH"),
  buyer("b16", "Orange City Pulses FPO", "FPO", "Nagpur", 21.1458, 79.0882, ["Tur (Pigeon Pea)", "Soybean"], 4500, 46, 72, ["Grade A", "Grade B"], 680, 87, 89, "Within 5 days", "MEDIUM"),
  buyer("b17", "Global Agri Exports JNPT", "Exporter", "Navi Mumbai", 18.9500, 72.9500, ["Soybean", "Tur (Pigeon Pea)", "Wheat"], 6000, 26, 74, ["Grade A"], 180, 86, 88, "Within 5 days", "MEDIUM"),
  buyer("b18", "Ahilyanagar Wholesale Grain Hub", "Wholesaler", "Ahilyanagar", 19.0948, 74.7480, ["Wheat", "Bajra (Pearl Millet)", "Chana (Chickpea)"], 4000, 23, 55, ["Grade A", "Grade B"], 155, 85, 87, "Within 4 days", "MEDIUM"),
];
